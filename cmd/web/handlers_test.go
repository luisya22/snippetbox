...
//	ping(rr, r)
//
//	// Call the Result() method on the http.ResponseRecorder to get the http.Response generated by the ping
//	// handler
//	rs := rr.Result()
//
...
func TestUserSignup(t *testing.T) {
	// Create the application struct containing our mocked dependencies and set up the test server for running
	// an end-to-end test.
	app := newTestApplication(t)
	ts := newTestServer(t, app.routes())
	defer ts.Close()
